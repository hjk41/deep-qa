...
def test_add_overlap_feature(inputdir, embeddingfile):
    alphabet, word_vectors = embedding.load_embedding(embeddingfile)
    dataset = datasets.load_dataset(inputdir,
                                    alphabet, True, None)
...
if __name__ == '__main__':
    ...
    test_add_overlap_feature(args.input, args.embedding)
